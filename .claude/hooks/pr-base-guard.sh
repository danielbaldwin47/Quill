...
# main. #222 and #228 were stranded that way on 2026-09-02 and needed a third
# PR (#242) to land what their merges had already called done
...
reason="PR #$n targets \`$base\`, whose own PR to main has merged: a merge there is stranded (#222, #228 on 2026-09-02). Retarget with \`gh pr edit $n --base main\` (docs/agents/issue-tracker.md, Open a ticket's PR)."

...
sudo pacman -U quill-*.pkg.tar.zst
...
```
cd legacy && npm i && cd ..               # once, for the tooling (playwright-core)
...
numbers and against frozen shots of the oracle in `shots/oracle/`.
...
shots/          every round's screenshots, blind pairs and the frozen oracle shots

...
Check and Authors off, window `{0,33,1512,982}`, `dev/ref/sample.md`.
...
spec has decided. `defaults.font` in `dev/shots/oracle/states.json` is `duo` and these frames are Mono,

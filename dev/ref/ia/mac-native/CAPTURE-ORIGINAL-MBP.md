...
[`../dev/shots/mac-native/raw-original-mbp/`](../dev/shots/mac-native/raw-original-mbp/); the normalised
...
`dev/ref/ia/mac-native/passage-syntax.md` for S1–S3 and `passage-syntax-tokens.md` for S4, Mono at the

...
table whose frames sit off it.
    ...
    .venv-rig/bin/python3 dev/ref/ia/mac-native/rig/ladder_419.py <scratch-dir> <window-pt>

The frames are scratch; the readings are kept as
`dev/ref/ia/mac-native/narrow-419-ladder-<window-pt>.json`. Run from the repository
...
KEEP = os.path.join("dev", "ref", "ia", "mac-native", f"narrow-419-ladder-{W}.json")

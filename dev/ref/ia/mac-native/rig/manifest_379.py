...
"""Write #379's capture manifest from the frames the three passes left.
    ...
    .venv-rig/bin/python3 dev/ref/ia/mac-native/rig/manifest_379.py
...
MAN = Path("dev/ref/ia/mac-native/capture-2026-09-13-library.json")
...
STATE = json.load(open("dev/ref/ia/mac-native/library-379.json"))
...
RIG = {
    ...
    "fixture": "dev/shots/oracle/library without manifest.json, ADDED to whatever the Library already "

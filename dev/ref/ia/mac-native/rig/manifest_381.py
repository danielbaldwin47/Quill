...
what makes a pair a pair.
    ...
    .venv-rig/bin/python3 dev/ref/ia/mac-native/rig/manifest_381.py
...
MAN = Path("dev/ref/ia/mac-native/capture-2026-09-13-stats.json")
...
STATE = json.load(open("dev/ref/ia/mac-native/stats-381.json"))

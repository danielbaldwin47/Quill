...
table if any row sits off it.
    ...
    .venv-rig/bin/python3 dev/ref/ia/mac-native/rig/margins_419.py <scratch-dir> <width-pt> ...
...
KEEP = os.path.join("dev", "ref", "ia", "mac-native", "narrow-419-margins-steps.json")

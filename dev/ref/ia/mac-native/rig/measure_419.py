...
the oracle's rule.
    ...
    .venv-rig/bin/python3 dev/ref/ia/mac-native/rig/measure_419.py [narrow-419.json]
...
PATH = os.path.join("dev", "ref", "ia", "mac-native", "narrow-419.json")
...
DATA = os.path.join("dev", "ref", "ia", "mac-native")
...
def main():
    ...
    if "--verify" in sys.argv:
        subprocess.run([sys.executable, os.path.join(HERE, "run_narrow_419.py"),
                        "dev/ref/ia/shots/mac-native/raw-2026-09-13", "dev/ref/ia/shots/mac-native",

...
show is written down rather than measured.
    ...
    .venv-rig/bin/python3 dev/ref/ia/mac-native/rig/measure_spell_400.py
...
FONT = os.path.join("dev", "ref", "ia", "fonts", "Mono", "iAWriterMonoS-Regular.ttf")
...
PASSAGE = os.path.join("dev", "ref", "spell.md")
LIMIT = 64
...
def main():
    ...
    json.dump(out, open(os.path.join("dev", "ref", "ia", "mac-native", "spell-400-marks.json"), "w"),
              indent=1)

...
bar under it at all, which is the one question a single frame cannot answer.
    ...
    .venv-rig/bin/python3 dev/ref/ia/mac-native/rig/measure_stats_381.py
...
STATE = os.path.join("dev", "ref", "ia", "mac-native", "stats-381.json")
...
def main():
    ...
    json.dump(out, open(os.path.join("dev", "ref", "ia", "mac-native", "stats-381-read.json"), "w"),
              indent=1)

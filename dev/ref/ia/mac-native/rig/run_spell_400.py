...
on `dev/ref/sample.md`, which has none — and on iA Mac the mark is macOS's own,
...
no second frame of the same page to difference against.
    ...
    .venv-rig/bin/python3 dev/ref/ia/mac-native/rig/run_spell_400.py <raw-dir> <norm-dir>
...
def main():
    ...
    appearance("light")
    light_only(out)
    path = os.path.join("dev", "ref", "ia", "mac-native", "spell-400.json")

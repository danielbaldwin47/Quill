...
position have never been measured. This shoots the passage `dev/ref/style.md` in
...
def main():
    ...
    json.dump(out, open("dev/ref/ia/mac-native/style-354.json", "w"), indent=1)

...
default true and the one thing that decides a heading's alignment under every Template,
`number_headings` and `indent_paragraphs`, the three toggles that bend one), a

...
result files are under [results/](results/) rather than `shots/latency/`. All
...
| --- | ---: | ---: | ---: | ---: | --- |
| `shots/latency/bench-syntax-20260910T024503.json` | 2.63 | 6.60 | 6.04 | 159.75 | pass |
| `shots/latency/bench-prose_end_of_draft-20260910T024538.json` | 2.31 | 8.19 | 7.04 | 164.70 | pass |
...
```sh
mkdir -p /tmp/r2 && tar xzf progress/diagnostics/ticket-327/round-2/records.tar.gz -C /tmp/r2
R=progress/diagnostics/ticket-327/round-2

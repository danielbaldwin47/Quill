...
than `shots/latency/`; the raw directories are in [records.tar.gz](records.tar.gz).
...
| --- | ---: | ---: | ---: | ---: | --- |
| `shots/latency/bench-bursts_and_pauses-20260910T134735.json` (`--sessions 2`) | 2.72 | 15.91 | 15.04 | 179.8 | pass |
| `shots/latency/bench-syntax-20260910T134817.json` | 2.34 | 4.72 | 4.28 | 164.4 | pass |
| `shots/latency/summary-20260910T135606.json` (`--all`) | — | — | — | — | **14 of 14 scored regimes pass** |
...
```sh
mkdir -p /tmp/r3 && tar xzf progress/diagnostics/ticket-327/round-3/records.tar.gz -C /tmp/r3
R=progress/diagnostics/ticket-327/round-3

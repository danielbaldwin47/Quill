...
pub const COMMANDS: &[Command] = &[
    ...
    row("export.pdf", "PDF…", Scope::Win, Kind::Plain, &["Ctrl+Shift+E"], &[place(DOC, None, "PDF…")], false),
    row("export.html", "HTML…", Scope::Win, Kind::Plain, &[], &[place(DOC, None, "HTML…")], false),
    row("export.markdown", "Markdown…", Scope::Win, Kind::Plain, &[], &[place(DOC, None, "Markdown…")], false),
    row("export.quick", "Quick Export PDF", Scope::Win, Kind::Plain, &["Ctrl+Shift+P"], &[place(DOC, None, "Quick Export PDF")], false),
    row("export.copyHtml", "Copy as HTML", Scope::Win, Kind::Plain, &["Ctrl+Shift+C"], &[place(DOC, None, "Copy as HTML")], false),

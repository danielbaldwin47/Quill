...
//! (#238), and the five Syntax highlight roles from #310. The rules are a
...
/// list left it out (#238), and the five Syntax highlight roles from #310. A
/// role missing here fails the test below by name.

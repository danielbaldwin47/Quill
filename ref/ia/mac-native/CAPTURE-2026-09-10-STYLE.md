...
`ref/ia/shots/mac-native/` up to this run was shot with Style Check **off** — the rig's own README
...
The passage is [`ref/style.md`](../../style.md), written by this ticket so that the capture, the

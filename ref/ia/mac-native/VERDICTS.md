...
| The **page top** — the first line at scroll 0, measured from the window's top edge, which is the editor's own: the text view runs to the frame under a title bar that draws nothing | first line box **164 px**, first ink **185 px**, at the default step; four region origins and both grounds agree. Whether the band includes room for the title bar, and whether it scales with the pitch, these captures cannot say | 01-dark, 01-light, 08-inline, 14-markup, 17-marks, 03-empty-document |

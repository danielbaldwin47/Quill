...
The Library must hold `shots/oracle/library/` without its `manifest.json` — six
...
would stop the folder going with it.
    ...
    .venv-rig/bin/python3 ref/ia/mac-native/rig/library_fixture_379.py --add
...
SRC = os.path.join("shots", "oracle", "library")
ADDED = os.path.join("ref", "ia", "mac-native", "library-379-added.json")
SKIP = {"manifest.json"}

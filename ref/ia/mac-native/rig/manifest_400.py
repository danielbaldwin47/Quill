...
which is what makes a pair a pair.
    ...
    .venv-rig/bin/python3 ref/ia/mac-native/rig/manifest_400.py
...
MAN = Path("ref/ia/mac-native/capture-2026-09-13-spell.json")
...
STATE = json.load(open("ref/ia/mac-native/spell-400.json"))
...
RIG = {
    ...
    "passage": "ref/spell.md, the spell Piece's own state and the engine test's fixture",

...
every one carries a `colour.check` and none is exempt.
    ...
    .venv-rig/bin/python3 ref/ia/mac-native/rig/manifest_419.py
...
MAN = Path("ref/ia/mac-native/capture-2026-09-13.json")
...
RIG = {
    ...
    "modes": "Library and Preview hidden; Focus, Typewriter, Syntax, Style Check and Authors off; "
             "markers visible",
    "passage": "ref/sample.md, scroll at the document top",
}

...
MANIFEST = Path("ref/ia/mac-native/capture-original-mbp.json")
SHOTS = Path("ref/ia/shots/mac-native")
...
def main():
    ...
    profile = Path("ref/ia/mac-native/rig/display.icc").read_bytes()
    ...
    assert digest("ref/ia/mac-native/rig/display.icc") == rig["normalised_into_sha256"]

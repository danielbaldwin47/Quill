...
# `ref/style.md` as the 64-cell measure wraps it. The heading is row 0 and the
...
FONT = "ref/ia/fonts/Mono/iAWriterMonoS-Regular.ttf"
...
if __name__ == "__main__":
    ...
    if "--json" in sys.argv:
        with open("ref/ia/mac-native/style-354-read.json", "w") as f:

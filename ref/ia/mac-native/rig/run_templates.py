...
#261 measured the Templates' pitches off `ref/sample.md`, whose first paragraph
...
both: `ref/short.md`, whose second paragraph follows a body paragraph, and
...
PASSAGES = [("short", "ref/short.md"),
            ("em", "ref/ia/mac-native/passage-template-em.md")]
...
def main():
    ...
    json.dump(out, open("ref/ia/mac-native/templates-343.json", "w"), indent=1)

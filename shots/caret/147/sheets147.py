...
sheet("caret", (1856, 786, 160, 88),
      [("shots/oracle/caret/caret.png", "oracle")]
...
sheet("selection-open", (900, 426, 160, 88),
      [("shots/oracle/caret/selection.png", "oracle"),
       ("shots/caret/r4-selection-ours.png", "round 4 (lost)")]
...
pair("caret", f"{DIR}/s1-caret.png", "shots/oracle/caret/caret.png",
     "judged `caret` state, whole frame")
pair("selection", f"{DIR}/s1-selection.png", "shots/oracle/caret/selection.png",

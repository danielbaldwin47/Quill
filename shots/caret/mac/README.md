...
`shots/caret/ia/shoot.mjs`, so they are the same 3200×2000 headless output at scale 2 and the same
...
measured by (`ref/ia/shots/owner-mac-03` and `-04`, catalogued in `ref/ia/REFERENCE.md` § 1.1): a
...
`shots/caret/ia/` is the other half of this: the Wine rig that drives iA Writer for Windows, and the

...
// The other three feature regimes are the headline regime plus one flag. This one is not: the
...
ok('stats is the nineteenth regime, and pauses like bursts_and_pauses rather than typing straight through', () => {
  ...
  assert.deepEqual(stats, {
    ...bursty,
    name: 'stats',
    stats: 'words,characters,charactersNoSpaces,sentences,paragraphs,readingTime',
  });
  assert.equal(stats.stats.split(',').length, 6, 'all six Statistics are checked');
